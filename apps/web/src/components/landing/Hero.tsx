      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start space-y-8 text-left">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#EFE9DB] border border-[#855300]/20 text-[#855300] text-xs sm:text-sm font-bold shadow-xs">
              <Sparkles className="w-4 h-4 text-[#F59E0B]" />
              <span>Convivencia sin peleas ni malos entendidos</span>
            </div>
